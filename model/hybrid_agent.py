...
class HybridRLAgent(FixedPolicyAgent):
    ...
    def make_move(self, q_values: Dict[str, torch.Tensor]):
        """
        ...
        for action_type, qval in q_values.items():
            ...
            if action_max_val == -np.inf:
                ...
                flat_ids.append(torch.argwhere(qval == action_max_val).cpu().item())
    ...
    def get_qvalues(self, game_phase: str) -> Dict[str, torch.Tensor]:
        """
